...
if(isset($_POST['ingresar'])||isset($_POST['guardar'])){
    ...
    \"$rut\",\"$DV\",\"$_POST[nombres]\",\"$_POST[apellidos]\",\"$_POST[edad]\",\"$mysqlfecha\",\"$_POST[ciudad]\",\"$_POST[provincia]\",\"$_POST[telefono]\",\"$_POST[direccion]\",\"$_POST[sexo]\",\"$_POST[pais]\")";
    ...
    if ($con->query($sql1) === TRUE) {
        print "<script>alert(\"Registro modificado satisfactoriamente\");window.location='../registroacademicoalumnos.php';</script>";
    } else {
    ...
    print "<script>window.location='../registroAcademicoAlumnosBuscar.php';</script>";
    }
}
