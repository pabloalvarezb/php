...
<table>
    <tr>
    <th><INPUT TYPE="button" NAME="administrador" VALUE="Administrador" CLASS="boton2" onclick="window.location.href='registroacademicoadministrador.php'"></th>
      <th><INPUT TYPE="button" NAME="alumnos" VALUE="Alumnos" CLASS="boton2" onclick="window.location.href='registroacademicomenualumno.php'"></th>
    </tr>
    <tr>
      <th><INPUT TYPE="button" NAME="modulos" VALUE="Módulos" CLASS="boton2" onclick="window.location.href='registroacademicomodulos.php'"></th>
      <th><INPUT TYPE="button" NAME="docentes" VALUE="Docentes" CLASS="boton2" onclick="window.location.href='registroacademicodocentes.php'"></th>
    </tr>
